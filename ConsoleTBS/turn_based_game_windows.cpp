...
void tbs::TurnBasedGame::ui_input_help_turn_on(const std::vector<u_input::UserInputButton>& allowed_user_input) {
    ...
    u_input::load_user_input_database(f_db::FileDatabaseId::kUserInputDescription);
    ...
    u_input::unload_user_input_database(f_db::FileDatabaseId::kUserInputDescription);
