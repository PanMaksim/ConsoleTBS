...
class Creature {
public:
	Creature(CreatureRace race, std::array<int, static_cast<int>(CreatureStatId::kCreatureStatMax)> target_creature_stats);
	...
	CreatureStat get_certain_stat_current_and_max(CreatureStatId creature_stat) const;
	int get_certain_stat_current_value(CreatureStatId creature_stat) const;
